...
```ini
[vpn]
host1 tinc_ip=10.1.3.10 ansible_ssh_host=11.11.11.10
host2 tinc_ip=10.1.3.20 ansible_ssh_host=11.11.11.20
host3 tinc_ip=10.1.3.30 ansible_ssh_host=11.11.11.30
```
